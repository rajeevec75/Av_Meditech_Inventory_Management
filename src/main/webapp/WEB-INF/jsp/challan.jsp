...
<html>
    <head>
        ...
        <style>
            ...
            .table-bordered th {
                background-color: lightgrey; /* Light background color for headers */
            }
                ...
                <div class="content-section">
                    ...
                    <div class="left-section">
                        <div style="display: flex; align-items: center;">
                            ...
                            <img src="<%= request.getContextPath()%>/image/logo.jpg" alt="Logo" class="logo1">
                            <div>
                            ...
                            <div>
                                ...
                                <div style="font-size: 20px;"> DSS 308, SECTOR 20, HUDA KAITHAL 136027</div>
                                <div style="font-size: 20px;">HUDA SECTOR 20, KAITHAL-136027</div>
                            </div>
                            <% } %>
                        </div>
                        ...
                        <div>
                            <div style="font-size: 20px;"><strong>MOB NO:</strong> 9728942623</div>
                            <div style="font-size: 20px;"><strong>E-Mail:</strong> accounts@lensehome.com</div>
                        </div>
                        <% } else if (storeName != null && storeName.equals("AV MEDITECH PVT LTD KAITHAL")) { %>
                        <div>
                            <div style="font-size: 20px;"><strong>MOB NO:</strong> 9728942623</div>
                            <div style="font-size: 20px;"><strong>E-Mail:</strong> accounts@avmeditech.com</div>
                        </div>
                        <% } else if (storeName != null && storeName.equals("AV MEDITECH GURUGRAM")) { %>
                        <div >
                            <div style="font-size: 20px"><strong>MOB NO:</strong> 9953605079</div>
                            <div style="font-size: 20px;"><strong>E-Mail:</strong> accounts@avmeditech.com</div>
                        </div>
                        <% } else if (storeName != null && storeName.equals("AV MEDITECH KAITHAL")) { %>
                        <div>
                            <div style="font-size: 20px;"><strong>MOB NO:</strong> 9812063111</div>
                            <div style="font-size: 20px;"><strong>E-Mail:</strong> accounts@avmeditech.com</div>
                        </div>
                        <% }%>
                    </div>
                    ...
                    <div class="divider"><svg height="100%" width="2px"><line x1="0" y1="0" x2="0" y2="100%" style="stroke:rgb(0,0,0);stroke-width:2" /></svg></div>
                ...
                <table class="table table-bordered" style="font-size: 20px;">
                    <thead>
                        <tr class="table-header">
                            ...
                            <th style="text-wrap: nowrap">Product</th>
                            <!--<th style="text-wrap: nowrap">Item Description</th>-->
                            <th style="text-wrap: nowrap">Serial Number/Batch Number</th>
                            <th style="text-wrap: nowrap">Exp. Date</th>
