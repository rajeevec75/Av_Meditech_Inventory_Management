...
<html lang="en">
                ...
                <div class="page-wrapper">
                    <div class="content">
                        ...
                        <ul class="table-top-head mob-view">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/stockReportSerialNumberWiseExportToExcel?startDate=${URLEncoder.encode(startDate, 'UTF-8')}&endDate=${URLEncoder.encode(endDate, 'UTF-8')}&itemBarCode=${URLEncoder.encode(itemBarCode, 'UTF-8')}&productName=${URLEncoder.encode(productName, 'UTF-8')}&brand=${URLEncoder.encode(selectedBrandId, 'UTF-8')}&productType=${URLEncoder.encode(selectedProductTypeId, 'UTF-8')}"
                                ...
                                <div class="row">
                                    <form name="saleForm" action="" method="get" class="row">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <div class="mb-3 add-product">
                                                    <label for="itemBarCode" class="form-label">Item Bar Code</label>
                                                    <input type="text" class="form-control"  name="itemBarCode" 
                                                           autocomplete="off" placeholder="Enter Bar Code Name" value="${itemBarCode}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-sm-6 col-12">
                                            <div class="mb-3 add-product" style="position: relative;">
                                                ...
                                                <div id="product-autocomplete-list" class="autocomplete-list"></div>
                                            </div>
                                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="action-table-data">
                                                            <a class="me-2 p-2 btn btn-primary" data-bs-toggle="modal" data-bs-target="#view-warranty" 
                                                               data-sale-id="${userResponse.purchaseItemSerialMasterId}" onclick="fetchData(${userResponse.purchaseItemSerialMasterId})">
                                                                Update
                                                            </a>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <div class="page-btn">
                                            <c:if test="${currentPage > 1}">
                                                <a href="${pageContext.request.contextPath}/stockReportSerialNumberWise?pageNumber=${currentPage - 1}&pageSize=${pageSize}&brand=${selectedBrandId}&productType=${selectedProductTypeId}&startDate=${startDate}&endDate=${endDate}&productName=${productName}" class="btn btn-secondary">Previous</a>
                                            </c:if>
                                        </div>&nbsp;&nbsp;
                                        <div class="page-btn">
                                            <c:if test="${currentPage < noOfPages}">
                                                <a href="${pageContext.request.contextPath}/stockReportSerialNumberWise?pageNumber=${currentPage + 1}&pageSize=${pageSize}&brand=${selectedBrandId}&productType=${selectedProductTypeId}&startDate=${startDate}&endDate=${endDate}&productName=${productName}" class="btn btn-secondary">Next</a>
                                            </c:if>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="updateItemDetails?startDate=${startDate}&endDate=${endDate}&itemBarCode=${itemBarCode}&productName=${productName}&brand=${brand}&productType=${productType}" method="post">

                                <div class="row">
                                    <input type="hidden" id="purchaseItemSerialMasterId" name="purchaseItemSerialMasterId" class="form-control">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-blocks image-upload-down">
                                            <label for="secondaryProductName">Product Search</label>
                                            <input type="text" id="secondaryProductName" placeholder="Search for other products..." autocomplete="off" name="newProductName">
                                            <div id="secondaryProductList" class="suggestion-list"></div>
                                        </div>


                                        <div class="input-blocks image-upload-down">
                                            <label for="itemSerialNumber">Serial Number</label>
                                            <input type="text" id="itemSerialNumber" name="newSerialNumber" class="form-control">
                                        </div>
                                        <div class="input-blocks image-upload-down">
                                        ...
                                        <div class="input-blocks image-upload-down">
                                            <label for="itemBarCode">Item Bar Code</label>
                                            <input type="text" id="itemBarCode" name="newBarCode" class="form-control">
                                        </div>
                                    </div>
    ...
    <script>
                                                                   ...
                                                                   function getSaleData() {
                                                                       ...
                                                                       document.saleForm.action = "stockReportSerialNumberWise";
    ...
    <script>
        function fetchData(purchaseItemSerialMasterId) {
            $.ajax({
                url: '${pageContext.request.contextPath}/retrieveStockReportBySerialNumberAndPurchaseId',
                method: 'GET',
                data: {
                    purchaseItemSerialMasterId: purchaseItemSerialMasterId,

                },
                success: function (response) {
                    if (response && response.length > 0) {
                        // Assuming response is an array with the first element containing the required data
                        let data = response[0];

                        // Populate the modal fields
                        $('#secondaryProductName').val(data.productName);
                        $('#itemSerialNumber').val(data.serialNumber);
                        $('#expiryDate').val(data.expiryDate);
                        $('#itemBarCode').val(data.itemBarCode);
                        $('#purchaseItemSerialMasterId').val(data.purchaseItemSerialMasterId);


                    } else {
                        alert("No data found for the given Purchase ID.");
                    }
                },
                error: function () {
    ...
    <script>
        ...
        <c:forEach items="${productTypeList}" var="productType">
            ...
            if (selectedProductType) {
                const selectedType = productTypeList.find(p => p.name === selectedProductType);
                if (selectedType) {
                    productTypeInput.value = selectedType.name;
                    productTypeIdInput.value = selectedType.name;
                }
            }
            ...
            function showSuggestions(value) {
                ...
                productTypeList.forEach((productType, index) => {
                    if (productType.name.toLowerCase().includes(value.toLowerCase())) {
                        const suggestionItem = document.createElement("div");
                        suggestionItem.textContent = productType.name;
                        suggestionItem.setAttribute("data-index", index);
                        suggestionItem.classList.add("autocomplete-item");

                        suggestionItem.addEventListener("click", function () {
                            productTypeInput.value = productType.name;
                            productTypeIdInput.value = productType.name;
                            autocompleteList.innerHTML = "";
                        });
            ...
            productTypeInput.addEventListener("keydown", function (e) {
                ...
                if (e.key === "ArrowDown") {
                    ...
                    if (selectedIndex > -1) {
                        ...
                        productTypeIdInput.value = selectedItem.textContent; // ? Corrected assignment
                        autocompleteList.innerHTML = "";
                    }
                    e.preventDefault();
                }
                ...
                // ? Auto-scroll feature added for better UX
        ...
        <c:forEach items="${categoryList}" var="category">
            ...
            if (selectedCategory) {
                ...
                if (selectedCat) {
                    ...
                    categoryHiddenInput.value = selectedCat.name;
                }
            }
                ...
                categoryList.forEach((category, index) => {
                    if (category.name.toLowerCase().includes(value.toLowerCase())) {
                        ...
                        suggestionItem.addEventListener("click", function () {
                            ...
                            categoryHiddenInput.value = category.name;
                            autocompleteList.innerHTML = "";
                        });
            ...
            categoryInput.addEventListener("keydown", function (e) {
                ...
                if (e.key === "ArrowDown") {
                    ...
                    if (selectedIndex > -1) {
                        ...
                        // ? FIX: Direct assignment if categoryList is a string array
                        if (Array.isArray(categoryList) && typeof categoryList[0] === "string") {
                            categoryHiddenInput.value = selectedItem.textContent;
                        } else {
                            // ? FIX: Use find() only if categoryList contains objects
                            const selectedCat = categoryList.find(c => c.name === selectedItem.textContent);
                            if (selectedCat) {
                                categoryHiddenInput.value = selectedCat.name;
                            }
                        }
