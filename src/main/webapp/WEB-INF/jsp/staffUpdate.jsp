        ...
        <div class="main-wrapper">
            ...
            <jsp:include page="sidebar.jsp"></jsp:include>
                <div class="page-wrapper">
                    ...
                    <!-- /add -->
                    <form action="processStaffUpdate" method="post">
                        <div class="card">
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header" id="headingOne">
                                            <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"  aria-controls="collapseOne">
                                                <div class="addproduct-icon">
                                                    <h5><i data-feather="info" class="add-info"></i><span>Update Staff Members Information</span></h5>
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                ...
                                                <input type="hidden" id="staffId" name="staffId" value="${staffDto.staffId}">

                                                <div class="row">
                                                    <div class="col-lg-4 col-sm-6 col-12">
                                                        <div class="mb-3 add-product">
                                                            <label class="form-label">First Name</label>
                                                            <input type="text" class="form-control" name="staffFirstName" required value="${staffDto.staffFirstName}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4 col-sm-6 col-12">
                                                        <div class="mb-3 add-product">
                                                            ...
                                                            <input type="text" class="form-control" name="staffLastName" required value="${staffDto.staffLastName}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4 col-sm-6 col-12">
                                                        <div class="mb-3 add-product">
                                                            ...
                                                            <input type="text" class="form-control" name="staffEmail" required value="${staffDto.staffEmail}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4 col-sm-6 col-12">
                                                        <div class="mb-3 add-product">
                                                            ...
                                                            <input type="text" class="form-control" name="staffMobileNo" required value="${staffDto.staffMobileNo}">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-sm-6 col-12">
                                                        <div class="mb-3 add-product">
                                                            ...
                                                            <select class="select" name="addGroups" required multiple>
                                                                ...
                                                                <!-- Populate dropdown with all available permissions -->
                                                                <c:forEach var="group" items="${permissionGroups}">
                                                                    <option value="${group.permissionGroupsId}">
                                                                        ${group.permissionGroupsName}
                                                                    </option>
                                                                </c:forEach>
                                                                <!-- Pre-select permissions associated with the staff member -->
                                                                <c:forEach var="permission" items="${staffDto.permissions}">
                                                                    <option value="${permission.permissionGroupsId}" selected>
                                                                        ${permission.permissionGroupsName}
                                                                    </option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-4 col-sm-6 col-12">
                                                        <div class="mb-3 add-product">
                                                            ...
                                                            <select class="select" name="addStores" required multiple>
                                                                <option value="">Select Stores</option>
                                                                <!-- Populate dropdown with all available stores -->
                                                                <c:forEach var="channel" items="${channelses}">
                                                                    <option value="${channel.channel_id}">
                                                                        ${channel.channelName}
                                                                    </option>
                                                                </c:forEach>
                                                                <!-- Pre-select stores associated with the staff member -->
                                                                <c:forEach var="staffChannel" items="${staffDto.channelses}">
                                                                    <option value="${staffChannel.channel_id}" selected>
                                                                        ${staffChannel.channelName}
                                                                    </option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                            ...
                            <div class="col-lg-12">
                                <div class="btn-addproduct mb-4">
                                    ...
                                    <button type="submit" class="btn btn-submit">Update Staff Members </button>
                                </div>
                            </div>
                    </form>
                    <!-- /add -->
