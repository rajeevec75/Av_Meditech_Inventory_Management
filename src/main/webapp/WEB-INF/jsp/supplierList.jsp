    ...
    <body>
                ...
                <div class="page-wrapper">
                    <div class="content">
                        ...
                        <c:if test="${autoLogin == null}">
                            <ul class="table-top-head mob-view">
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/supplierListExportToExcel?mobileNo=${URLEncoder.encode(mobileNo, 'UTF-8')}&userCode=${URLEncoder.encode(userCode, 'UTF-8')}&companyName=${URLEncoder.encode(companyName, 'UTF-8')}" 
                            ...
                            <div class="page-btn mob-view">
                                <a href="${pageContext.request.contextPath}/addUser" class="btn btn-added"><i data-feather="plus-circle" class="me-2"></i>Add New Supplier</a>
                            </div>
                        </c:if>
                    </div>
                    ...
                    <div class="card table-list-card">
                        <div class="card-body">
                            <div class="table-top">
                                <div class="row">
                                    <form class="row" name="supplierForm" onsubmit="return false;">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3 add-product">
                                                <button type="submit" onclick="getSupplierData()" class="btn btn-submit sub-btn">Submit</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table datanew1">
                                    ...
                                    <tbody>
                                        ...
                                        <% List<CustomerAndSupplierDto> supplierList = (List<CustomerAndSupplierDto>) request.getAttribute("supplierList");

                                            if (supplierList != null) {
                                                int index = 1;
                                                for (CustomerAndSupplierDto customerDto : supplierList) {
                                        %>
                                        <tr>
                                            ...
                                            <td class="action-table-data">
                                                <div class="edit-delete-action">
                                                    <a class="me-2 p-2" href="${pageContext.request.contextPath}/updateUser?supplierId=<%= customerDto.getId()%>">
                                                        <i data-feather="edit" class="feather-edit"></i>
                                                    </a>
                                                    <a class="confirm-text p-2" href="${pageContext.request.contextPath}/deleteUser?supplierId=<%= customerDto.getId()%>">
        ...
        <script>
            ...
            function getSupplierData() {
                ...
                document.supplierForm.action = "supplierList";
                document.supplierForm.submit(); // Submit the form programmatically
            }

            // Prevent form submission on Enter key
            document.supplierForm.addEventListener("keydown", function (event) {
                if (event.key === "Enter") {
