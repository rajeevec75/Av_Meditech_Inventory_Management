        ...
        <div class="main-wrapper">
                        ...
                        <div class="page-header">
                            <div class="add-item d-flex">
                                <div class="page-title mob-view">
                                    <h4>Combined Stock Report Product Wise</h4>
                                    <h6>Manage your Combined Stock Report Product Wise</h6>
                                </div>							
                            </div>
                            <ul class="table-top-head mob-view">

                                <li>
                                    <a href="${pageContext.request.contextPath}/combinedReportProductWiseExportToExcel?productName=${URLEncoder.encode(productName, 'UTF-8')}&productType=${URLEncoder.encode(productType, 'UTF-8')}&brand=${URLEncoder.encode(brand, 'UTF-8')}" 
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <div class="page-btn">
                                            <c:if test="${currentPage > 1}">
                                                <a href="${pageContext.request.contextPath}/combinedStockReport?pageNumber=${currentPage - 1}&pageSize=${pageSize}" class="btn btn-secondary">Previous</a>
                                            </c:if>
                                        </div>&nbsp;&nbsp;
                                        <div class="page-btn">
                                            <c:if test="${currentPage < noOfPages}">
                                                <a href="${pageContext.request.contextPath}/combinedStockReport?pageNumber=${currentPage + 1}&pageSize=${pageSize}" class="btn btn-secondary">Next</a>
                                            </c:if>
                                        </div>
                                    </div>
                                </div>
            ...
            <script>
                function getStockReportProductWise() {
                    ...
                    document.stockReportProductWise.action = "combinedStockReport";
                        ...
                        inputField.addEventListener("keydown", function (e) {
                            ...
                            items.forEach((item, i) => {
                                if (i === selectedIndex) {
                                    ...
                                    item.scrollIntoView({block: "nearest", behavior: "smooth"}); // SCROLL FIX
                                } else {
