        ...
        <div class="main-wrapper">
            ...
            <jsp:include page="sidebar.jsp"></jsp:include>
                ...
                <div class="page-wrapper">
                    ...
                    <!-- /add -->
                    <form action="processAddressUpdate" method="post">
                        <!-- Hidden input field for customerId -->
                        <input type="hidden" id="addressId" name="addressId" value="${addressDto.addressId}">
                        <input type="hidden" id="customerId" name="customerId" value="${addressDto.customerId}">
                        <div class="card">
                                        ...
                                        <div class="accordion-header" id="headingOne">
                                            <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne"  aria-controls="collapseOne">
                                                <div class="addproduct-icon">
                                                    <h5><i data-feather="info" class="add-info"></i><span>Address Update Information</span></h5>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-sm-6 col-12">
                                                        <div class="mb-3 add-product">
                                                            ...
                                                            <input type="text" class="form-control" name="streetAddress1" required value="${addressDto.streetAddress1}">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-sm-6 col-12">
                                                        <div class="mb-3 add-product">
                                                            <label class="form-label">Address 2</label>
                                                            <input type="text" class="form-control" name="streetAddress2"  value="${addressDto.streetAddress2}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4 col-sm-6 col-12">
                                                        <div class="mb-3 add-product">
                                                            ...
                                                            <input type="text" class="form-control" name="city" required value="${addressDto.city}">
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-4 col-sm-6 col-12">
                                                        <div class="mb-3 add-product">
                                                            <label class="form-label">Choose Country <span style="color: red">*</span></label>
                                                            <select class="select" name="country" required>
                                                                <option value="">Select  Country</option>
                                                                <option value="USA" <% if ("USA".equals("USA")) { %> selected <% } %>>USA</option>
                                                                <option value="UK" <% if ("UK".equals("UK")) { %> selected <% } %>>UK</option>
                                                                <option value="IN" <% if ("IN".equals("IN")) { %> selected <% }%>>IN</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4 col-sm-6 col-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input id="state-input" class="form-control" placeholder="Type to search..."  autocomplete="true" name="countryArea" value="${addressDto.countryArea}"/>
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-4 col-sm-6 col-12">
                                                        <div class="mb-3 add-product">
                                                            <label class="form-label">Postel Code <span style="color: red">*</span></label>
                                                            <input type="text" class="form-control" name="postalCode" required value="${addressDto.postalCode}">
                                                        </div>
                                                    </div>
