                ...
                <div class="page-wrapper">
                    <div class="content">
                        <div class="page-header">
                            <div class="add-item d-flex">
                                <div class="page-title">
                                    <h2>Show Sale Return Details</h2>
                        ...
                        <ul class="table-top-head">
                            ...
                            <li>
                                <div class="page-btn">
                                    <a target="_blank" href="${pageContext.request.contextPath}/saleReturnDeliveryChallan?saleReturnId=${response.sale.saleId}" class="btn btn-secondary">
                                        Print Challan</a>
                                </div>
                            </li>
                            <li>
                                <div class="page-btn">
                                    <a target="_blank" href="${pageContext.request.contextPath}/saleReturnDeliveryChallanQuantity?saleReturnId=${response.sale.saleId}" class="btn btn-secondary">
                    ...
                    <!-- /add -->
                    <form autocomplete="off" name="sale_return_form" id="fileUploadForm" enctype="multipart/form-data" action="" method="post">
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="mb-3 add-product product-section">
                                    ...
                                    <input type="hidden" name="customerId" id="customerId" id="hiddenUserId" value="${response.sale.customerId}">
                            ...
                            <div class="col-lg-4 col-sm-6 col-12">
                                <div class="mb-3 add-product">
                                    ...
                                    <input type="date" class="form-control" value="${response.sale.saleDate}" name="sale_return_date">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6 col-12">
                                <div class="mb-3 add-product">
                                    ...
                                    <input type="text" class="form-control" name="referenceNo" value="${response.sale.referenceNo}" >
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6 col-12">
                                <div class="mb-3 add-product">
                                    ...
                                    <input type="text" class="form-control" name="remarks" value="${response.sale.salestatus}" >
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6 col-12">
                                <div class="mb-3 add-product">
                                    ...
                                    <input type="text" class="form-control" readonly value="${response.sale.saleReturnSeqId}" >
                                </div>
                            </div>  
                                    ...
                                    <div class="total-order p-3 border rounded mb-4">
                                        <ul class="list-unstyled">
                                            <li class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <h5 class="mb-0">Rs <span id="purchaseSubtotal">0.00</span></h5>
                                            </li>
                                            <li class="d-flex justify-content-between align-items-center mb-3">
                ...
                <c:forEach var="item" items="${response.saleItemsMasters}">
                    ...
                    if ('${item.trackingSerialNo}' === 'true') {
                        newRow = '<tr id = "row' + '${item.productId}' + '">' +
                                ...
                                '<td class="action-table-data"><div class="edit-delete-action"><a class="confirm-text p-2" onclick = "deleteData(\'row' + '${item.productId}' + '\',\'0\')"><i data-feather="trash-2" class="feather-trash-2"></i></a></div></td>' +
                                '</tr>';
                        ...
                        if ('${item.isBatch}') {
                            newRow = '<tr id = "row' + index + '">' +
                                    '<td><a href="#" class="btn btn-added" onclick=showPopupData(\'' + '${item.productId}' + '\') data-bs-toggle="modal" data-bs-target="#add-sales-new">' + '${item.productName}' + '</a></td>' +
                                    '<td><input readonly id = "quantity' + index + '" onchange = "editDataRow1(\'row' + index + '\',\'0\',\'\',\'0\',\'' + '${item.itemBarCode}' + '\')" style="width:100px;" type="number" value="' + '${item.quantity}' + '"/><br /><input type = "hidden" id = "batchSerialNo' + index + '" onchange = "editDataRow(\'row' + '${item.productId}' + '\',\'0\',\'\',\'0\',\'' + '${item.itemBarCode}' + '\')" style="width:100px;">';
...
//                            }
                            ...
                            newRow = newRow + '</input></td>' +
                                    '<td class="action-table-data"><div class="edit-delete-action"><a class="confirm-text p-2" onclick = "deleteData1(\'row' + index + '\',\'0\', \'' + '${item.productId}' + '\')"><i data-feather="trash-2" class="feather-trash-2"></i></a></div></td>' +
                                    '</tr>';
                        } else {
                            newRow = '<tr id = "row' + index + '">' +
                                    ...
                                    '<td class="action-table-data"><div class="edit-delete-action"><a class="confirm-text p-2" onclick = "deleteData1(\'row' + index + '\',\'0\')"><i data-feather="trash-2" class="feather-trash-2"></i></a></div></td>' +
                                    '</tr>';
                        }
                                        ...
                                        if (response.trackingSerialNo) {
                                            ...
                                            if (response.batchSerialNo) {
                                                ...
                                                newRow = newRow + '</select></td>' +
                                                        '<td class="action-table-data"><div class="edit-delete-action"><a class="confirm-text p-2" onclick = "deleteData2(\'roww' + index + '\',\'' + response.gstPercent + '\')"><i data-feather="trash-2" class="feather-trash-2"></i></a></div></td>' +
                                                        '</tr>';
                                            } else {
                                                newRow = '<tr id = "row' + index + '">' +
                                                        '<td>' + response.productName + '</td>' +
                                                        ...
                                                        '<td class="action-table-data"><div class="edit-delete-action"><a class="confirm-text p-2" onclick = "deleteData(\'row' + index + '\',\'' + response.gstPercent + '\')"><i data-feather="trash-2" class="feather-trash-2"></i></a></div></td>' +
                                                        '</tr>';
                                            }
...
//                                            row.cells[1].innerHTML = '<td><input id = "quantity' + response.productId + '" onchange = "editDataRow(\'row' + response.productId + '\',\'' + response.gstPercent + '\',\'' + response.serialNumber + '\',\'' + response.costPrice + '\',\'' + response.itemBarCode + '\')" style="width:75px;" type="number" value="' + quantity + '"/></td>';
                ...
                function addSaleData() {
                    ...
                    toggleLoader(true);
                    document.sale_return_form.action = "updateStockCreate";
                    document.sale_return_form.submit();
